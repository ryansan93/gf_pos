        ...
        <div class="col-lg-12" style="padding-top: 10px;">
            ...
            <div class="col-md-12 no-padding" style="padding-top: 2%;">
                <div class="input-group">
                    ...
                    <input id="jumlah_uang" type="text" data-tipe="decimal" class="form-control text-right" placeholder="SALDO AWAL KASIR" maxlength="13" value="<?php echo angkaDecimal($nominal); ?>">
                </div>
            </div>
            <div class="col-md-12 no-padding" style="padding-top: 2%;">
                <button type="button" class="col-md-12 btn btn-primary" onclick="sak.saveSaldoAwalKasir()"><i class="fa fa-check"></i> Simpan</button>
            </div>
        </div>
    </div>
</div>