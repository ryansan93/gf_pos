	...
	<div class="col-xs-3 no-padding faktur">
		<div class="col-xs-12 no-padding border">
			...
			<div class="col-xs-12 no-padding">
				...
				<div class="col-xs-4 no-padding cb_left cb_right">
					<button type="button" class="col-xs-12 btn btn-danger" onclick="bayar.hapusPembayaran(this);" data-kode="<?php echo $data['kode_faktur']; ?>"><i class="fa fa-trash"></i> Hapus</button>
				</div>
				<div class="col-xs-4 no-padding cb_right">
